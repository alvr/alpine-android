...
* JDK17 images are based on Liberica JDK 17.0.19 and uses the tag's suffix `-jdk17`.
* JDK21 images are based on Liberica JDK 21.0.11 and uses the tag's suffix `-jdk21`.
...
<details>
  <summary>See content of Android 17.0 (CinnamonBun) image</summary>

![Docker Android 17.0 JDK8 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.0-jdk8?label=jdk8%20image%20size) ![Docker Android 17.0 JDK11 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.0-jdk11?label=jdk11%20image%20size) ![Docker Android 17.0 JDK17 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.0-jdk17?label=jdk17%20image%20size) ![Docker Android 17.0 JDK21 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.0-jdk21?label=jdk21%20image%20size)

| Path                          | Version    | Description                         | Location                   |
|-------------------------------|------------|-------------------------------------|----------------------------|
| build-tools;37.0.0            | 37.0.0     | Android SDK Build-Tools             | build-tools/37.0.0/        |
| extras;google;instantapps     | 1.9.0      | Google Play Instant Development SDK | extras/google/instantapps/ |
| patcher;v4                    | 1          | SDK Patch Applier v4                | patcher/v4/                |
| platform-tools                | 37.0.0     | Android SDK Platform-Tools          | platform-tools/            |
...
<details>
  <summary>See content of Android 17.1 (CinnamonBun) image</summary>

![Docker Android 17.1 JDK8 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.1-jdk8?label=jdk8%20image%20size) ![Docker Android 17.1 JDK11 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.1-jdk11?label=jdk11%20image%20size) ![Docker Android 17.1 JDK17 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.1-jdk17?label=jdk17%20image%20size) ![Docker Android 17.1 JDK21 Size](https://img.shields.io/docker/image-size/alvrme/alpine-android/android-37.1-jdk21?label=jdk21%20image%20size)

| Path                          | Version    | Description                         | Location                   |
|-------------------------------|------------|-------------------------------------|----------------------------|
| build-tools;37.1.0            | 37.1.0     | Android SDK Build-Tools             | build-tools/37.1.0/        |
| extras;google;instantapps     | 1.9.0      | Google Play Instant Development SDK | extras/google/instantapps/ |
| patcher;v4                    | 1          | SDK Patch Applier v4                | patcher/v4/                |
| platform-tools                | 37.0.0     | Android SDK Platform-Tools          | platform-tools/            |
